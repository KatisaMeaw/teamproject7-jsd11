            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              {cartItems.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="flex flex-col md:items-center">
                        ...
                        <input
                          ...
                          value={item.quantity}
                          onChange={(e) =>
                            handleQuantityChange(item._id || item.id, e.target.value)
                          }
                ...
                <div className="p-20 text-center">
                  ...
                  <Link to="/shop" className="inline-block bg-[#447F98] text-white px-8 py-3 rounded-xl font-bold hover:bg-blue-700 transition-all shadow-md">
                    Start Shopping
                  </Link>
                </div>
              )}
