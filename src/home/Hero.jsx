...
const Hero = () => {
  return (
     <div
      ...
      >
        <div
          className="w-[90%] sm:w-3/4 md:w-[550px] lg:w-[700px] h-auto bg-[#B9D8E1]/80 backdrop-blur-sm p-8 md:p-12 lg:p-16 rounded-2xl shadow-2xl flex flex-col"
        >
          <div>
            <p className="text-[#629BB5] font-medium mb-2 text-sm md:text-base">New Arrival</p>
            <h1 className="font-bold text-[#447F98] text-4xl md:text-5xl lg:text-7xl mb-6">
              Discover Our <br />New Collection
            </h1>
            <p className="text-[#629BB5] font-medium text-base lg:text-lg">
