    ...
    <div className="w-full bg-[#eef7fb] py-12 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="flex items-center gap-4">
          <img src="icon/trophy 1.png" alt="" className="text-5xl text-gray-800 h-10 w-10"/>
        ...
        <div className="flex items-center gap-4">
            <img src="icon/Group.png" alt="" className="text-5xl text-gray-800 h-10 w-10"/>
          <div className="flex flex-col">
            ...
            <p className="text-sm text-gray-500">Over 2 years</p>
             ...
             <div className="flex items-center gap-4">
            <img src="icon/Vector.png" alt="" className="text-5xl text-gray-800 h-10 w-10"/>
          <div className="flex flex-col">
        ...
        <div className="flex items-center gap-4">
            <img src="icon/customer-support.png" alt="" className="text-5xl text-gray-800 h-10 w-10"/>
          <div className="flex flex-col">
